...
- **Lecciones del frente** — los errores que ya pagamos para que no los pagues tú
- **Código que copy-pasteas** — y funciona

No es un manual académico. Es el toolkit de alguien que construye con LLMs todos los días.
...
Todo vive en `content/` como módulos JSON. Los temas están indexados en `topics.json`. Tienes dos opciones:
...
*PD: Si ves algo que no tiene sentido, probablemente tengas razón. Las mejores ideas vienen de quien usa la herramienta.*